...
class TestStudentModelNewFunctions:
    ...
    # NOTE: The following methods are not implemented in Student entity (commented out):
    # - Enroll_course
    # - Submit_assignment
    # - View_GPA
    # - get_submissions
    # - Drop_course
    # 
    # All tests below are commented out until these methods are implemented
    
    pass  # Placeholder - all tests commented out
